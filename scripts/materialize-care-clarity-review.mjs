...
const infoObj = addObject(`<< /Title (Common Ground - Care Clarity & Review Sheet) /Author (${SITE.orgName}) /Subject (Private fillable care clarity and review worksheet for parent use) /Creator (Common Ground worksheet materializer) >>`);
