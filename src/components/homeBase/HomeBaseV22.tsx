...
export default function HomeBaseV22() {
  ...
  return <div className="space-y-4 pb-5">
    ...
    <section className="relative min-h-[190px] overflow-hidden rounded-[1.6rem] border border-primary/15 bg-gradient-to-br from-white via-white to-teal-50/70 p-6 shadow-[0_15px_45px_rgba(26,46,82,0.075)] sm:min-h-[205px]">
      <div className="relative z-10 max-w-[58%] min-w-[300px] sm:min-w-[360px]"><span className="inline-flex rounded-full bg-teal-100/80 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.14em] text-teal-800">Continue where you left off</span><h2 className="mt-3 text-2xl font-semibold text-brand-navy-800">{continuation.title}</h2><p className="mt-2 max-w-2xl text-[13px] leading-relaxed text-brand-muted-600">{continuation.body}</p><Link href={continuation.href} className="mt-5 inline-flex min-h-11 items-center gap-2 rounded-2xl bg-primary px-5 py-2.5 text-[13px] font-semibold text-white shadow-soft transition hover:-translate-y-0.5 hover:bg-primary/90">{continuation.action}<ArrowRight className="h-4 w-4" /></Link></div>
      <div aria-hidden="true" className="pointer-events-none absolute inset-y-0 right-0 hidden w-[49%] sm:block">
        <div className="absolute right-[18%] top-[20%] h-16 w-16 rounded-full bg-amber-100/80 shadow-[0_0_38px_rgba(251,191,36,0.16)]" />
        <div className="absolute bottom-0 right-0 h-[53%] w-[88%] rounded-tl-[100%] bg-gradient-to-br from-teal-50 via-cyan-100/75 to-emerald-100/90" />
        <div className="absolute bottom-0 right-[18%] h-[42%] w-[72%] rounded-tr-[100%] bg-gradient-to-br from-sky-50 via-teal-50 to-cyan-100/80" />
        <div className="absolute bottom-[-5%] right-[30%] h-[46%] w-9 rotate-[16deg] rounded-[100%] bg-white/95 shadow-[0_0_18px_rgba(255,255,255,0.7)]" />
        <div className="absolute bottom-[26%] right-[10%] h-16 w-3 rounded-t-full bg-teal-500/55"><span className="absolute -left-3 -top-4 h-10 w-9 rounded-[55%] bg-teal-400/55" /></div>
        <div className="absolute bottom-[21%] right-[23%] h-14 w-2.5 rounded-t-full bg-teal-500/45"><span className="absolute -left-2.5 -top-3 h-8 w-7 rounded-[55%] bg-teal-300/65" /></div>
        <div className="absolute bottom-[18%] right-[34%] h-10 w-2 rounded-t-full bg-teal-500/40"><span className="absolute -left-2 -top-2 h-6 w-6 rounded-[55%] bg-teal-300/55" /></div>
        <div className="absolute right-[30%] top-[28%] h-4 w-10 rounded-full bg-sky-50/90" />
        <div className="absolute right-[9%] top-[34%] h-3 w-8 rounded-full bg-sky-50/80" />
      </div>
    </section>
