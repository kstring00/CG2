...
> = {
  'aba-therapy': {
    ...
    description: 'Applied Behavior Analysis — the most commonly covered autism therapy.',
  },
  'speech-therapy': {
...
export const startHereRoutes: {
  ...
  },
  {
    ...
    firstCallId: 'action-behavior-houston',
  },
  {
    id: 'overwhelmed',
...
export const providers: Provider[] = [
  ...
  {
    id: 'autism-pediatric-therapy-pearland',
    category: 'aba-therapy',
    provider_name: 'Autism Pediatric Therapy & Learning Center',
    location: 'Pearland & Houston (Space Park Dr, Clear Lake area)',
    services: [
      'One-on-one ABA therapy',
      'Group social skills sessions',
      'Language development support',
      'Behavior intervention plans for home',
    ...
    age_range: '18 months – 12 years',
    insurance_notes: 'Accepts most major employer insurance (Blue Cross, United Healthcare, and others). Does not accept Medicaid. Call to verify your plan.',
    referral_required: false,
    waitlist_status: 'Call to verify',
    languages_offered: ['English'],
    service_type: ['in-person'],
    sensory_accommodations: 'Call to ask about clinic environment setup',
    website: 'https://www.autismpediatrictherapy.com',
    phone: '(832) 281-6098',
    why_it_may_help: 'A local, independently-owned ABA center with locations in Pearland and Clear Lake — two areas heavily served by Texas ABA families. They offer parent training, sibling workshops, and free community events that go beyond just therapy hours.',
    helpful_to_know: 'Houston location (Space Park Dr) is close to Webster and League City. Pearland location is on Broadway. Call or text either number for a faster response: (832) 281-6098 or (713) 355-0623.',
    last_verified_date: 'April 2026',
    recommendation_level: 'great-first-call',
  },
  {
    id: 'action-behavior-houston',
    category: 'aba-therapy',
    provider_name: 'Action Behavior Centers – Houston Region',
    location: 'Multiple Houston-area locations (Cypress, Memorial, Katy, Sugar Land, The Woodlands)',
    services: [
      'Center-based ABA therapy (ages 18 months–8 years)',
      'In-home ABA therapy (ages 18 months–13 years)',
      'ABC Academy school-readiness program (ages 5–12)',
      'Autism diagnostic support & ADOS-2 assessments (under age 6)',
      'Social skills development',
      'Parent training and support',
    ],
    age_range: '18 months – 13 years',
    insurance_notes: 'Accepts major insurance plans. Free no-cost autism assessment for new families. Call to verify your plan.',
    referral_required: false,
    waitlist_status: 'Immediate availability reported for some locations — call to confirm',
    languages_offered: ['English', 'Spanish (varies by location)'],
    service_type: ['in-person', 'mobile'],
    sensory_accommodations: 'Call individual center to ask about accommodations',
    website: 'https://www.actionbehavior.com/city/houston',
    phone: '(844) 355-0234',
    why_it_may_help: 'One of the largest ABA networks in Texas with multiple Houston-area clinics. If one location has a waitlist, another may have immediate openings. They offer on-site diagnostic assessments, which can save families weeks of waiting.',
    helpful_to_know: 'Has 80+ centers nationally with consistent clinical standards. Good option if you want a well-resourced provider with multiple Houston locations. Barker Cypress location (Cypress, TX) is a commonly recommended option for northwest Houston families.',
    last_verified_date: 'April 2026',
    recommendation_level: 'great-first-call',
  },
  {
    id: 'behavioral-innovations-barker-cypress',
    category: 'aba-therapy',
    provider_name: 'Behavioral Innovations – Barker Cypress',
    location: 'Cypress, TX (Barker Cypress Rd)',
    services: [
      'Center-based ABA therapy',
      'Autism diagnostic testing (under age 6)',
      'Social skills development',
      'Parent training',
    ],
    age_range: 'Early childhood (contact for full age range)',
    insurance_notes: 'Accepts major insurance. In-person and virtual testing options for evaluation.',
    referral_required: false,
    waitlist_status: 'Call to verify',
    languages_offered: ['English'],
    service_type: ['in-person', 'virtual'],
    website: 'https://behavioral-innovations.com/locations/barker-cypress/',
    phone: '(855) 782-7822',
    why_it_may_help: 'Offers both ABA therapy and autism diagnostic evaluations at the same center — which means families can get assessed and begin services without being referred across multiple organizations.',
    helpful_to_know: 'Part of a regional multi-site network. Consistent clinical model across locations. If Barker Cypress has a wait, ask about other Houston-area Behavioral Innovations clinics.',
    last_verified_date: 'April 2026',
    recommendation_level: 'great-first-call',
  },
  {
    id: 'key-autism-sugar-land',
    category: 'aba-therapy',
    provider_name: 'Key Autism Services – Sugar Land',
    location: 'Sugar Land, TX (Hwy 6)',
    services: [
    ...
    age_range: 'Contact to confirm',
    insurance_notes: 'Call to verify insurance acceptance. In-home services available across Sugar Land, Missouri City, Richmond, Rosenberg, Pasadena, Houston, Katy, Cypress, and surrounding areas.',
    referral_required: false,
    waitlist_status: 'Call to verify',
    languages_offered: ['English'],
    service_type: ['in-person', 'mobile'],
    website: 'https://www.keyautismservices.com/autism-aba-therapy-in-sugarland-center/',
    phone: '(888) 329-4535',
    why_it_may_help: 'Located in Sugar Land with in-home coverage across Fort Bend and surrounding areas. Specifically noted for strong parent training and working collaboratively with schools.',
    helpful_to_know: 'FEAT Houston has listed this as a verified Houston-area ABA resource. In-home services reach many southwest Houston zip codes.',
    last_verified_date: 'April 2026',
...

  {
    ...
    services: [
      ...
      'ADHD/autism-focused caregiver support',
    ...
    why_it_may_help: 'If you need a therapist who specifically understands autism parenting — not just general therapy — use Psychology Today\'s filter to find providers in Houston who list autism caregivers as a specialty. Several Houston therapists also run autism-parent groups listed on this page.',
    helpful_to_know: 'Filter by "insurance accepted," "telehealth available," and "autism" to narrow results quickly. Many therapists have weekend and evening availability. Parent groups listed on this page start at $50/session.',
    last_verified_date: 'April 2026',
    recommendation_level: 'great-first-call',
  },
  {
    id: 'luna-family-autism-services',
    category: 'parent-mental-health',
    provider_name: 'Luna Family Autism Services',
    location: 'Houston, TX 77008 (virtual-first)',
    services: [
      'Virtual ABA therapy with heavy family involvement',
      'Parent coaching and caregiver tools',
      'Family empowerment approach',
      'Caregiver training for home behavior support',
    ],
    age_range: 'Contact to confirm',
    ...
    website: 'https://www.psychologytoday.com/us/groups/tx/houston?category=autism',
    phone: '(832) 648-2573',
    why_it_may_help: 'Designed specifically around giving caregivers the tools they need to support their child at home — not just therapy hours. If you feel like therapy is happening in a bubble and nothing carries over to real life, this model is built to fix that.',
    helpful_to_know: 'Virtual-first model means no commute. Heavy emphasis on caregiver involvement — expect to participate actively in sessions and practice between appointments.',
    last_verified_date: 'April 2026',
    recommendation_level: 'specialized-support',
  },
  ...
  },
  {
    ...
    phone: 'See website for current contact',
    why_it_may_help: 'FEAT Houston maintains one of the most detailed autism provider directories specific to the greater Houston area. Their site lists ABA centers, day programs, schools, and recreational resources with contact information — a valuable cross-reference when building your service team.',
    helpful_to_know: 'Based in the Clear Lake / Bay Area, making it especially relevant for families in southeast Houston, Webster, League City, and Pearland. Their provider listings are community-maintained — always call to verify current status.',
    last_verified_date: 'April 2026',
