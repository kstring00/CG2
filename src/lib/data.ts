...
export const resources: Resource[] = [
  ...
  // ── Caregiver Wellness — example placeholders pending vetting ─────────
  {
    id: 'r-cg-burnout',
    title: 'Caregiver burnout — recognizing the signs',
    description:
      'A short, parent-facing self-assessment. Names what burnout looks like for parents of autistic children specifically — not generic wellness content.',
    category: 'caregiver-wellness',
    tags: ['burnout', 'self-assessment', 'caregiver mental health'],
    ageRanges: ['0-2', '2-5', '6-12', '13-17'],
    readTime: '6 min',
    isFeatured: false,
    journeyStages: ['starting-therapy', 'school-transition'],
    whyNow: 'Burnout is the single biggest risk to a family system, and parents almost never name it on themselves first.',
    whoItsFor: 'Caregivers who suspect they may be running on empty and want a kind, structured way to check.',
    question: 'How do I tell if what I’m feeling is normal exhaustion or something more?',
    action: 'Walk the 6-question self-assessment. Whatever comes up, the next page is gentle.',
    reviewedBy: 'Common Ground (placeholder content)',
    lastUpdated: 'May 2026',
    isDemo: true,
  },
  {
    id: 'r-cg-therapy-finder',
    title: 'Therapy for special-needs parents — how to find one',
    description:
      'A walkthrough of how to find a therapist who actually understands what it is to parent an autistic child. Includes language to use when you call.',
    category: 'caregiver-wellness',
    tags: ['therapy', 'mental health', 'caregiver care'],
    ageRanges: ['0-2', '2-5', '6-12', '13-17'],
    readTime: '8 min',
    isFeatured: false,
    journeyStages: ['just-diagnosed', 'starting-therapy', 'school-transition'],
    whyNow: 'Most parents don’t know how to filter for a therapist who gets the specific weight of this. This makes it concrete.',
    whoItsFor: 'Parents ready to look for their own therapist but not sure where to start or what to say.',
    question: 'How do I find a therapist who actually understands what we’re carrying?',
    action: 'Use the language script when you call your insurance and the search filters when you browse Psychology Today.',
    reviewedBy: 'Common Ground (placeholder content)',
    lastUpdated: 'May 2026',
    isDemo: true,
  },
  {
    id: 'r-cg-grief',
    title: 'The grief you’re allowed to feel',
    description:
      'A short essay on the kind of grief that comes with parenting through a diagnosis — and the permission to hold it alongside love.',
    category: 'caregiver-wellness',
    tags: ['grief', 'identity', 'caregiver mental health'],
    ageRanges: ['0-2', '2-5', '6-12', '13-17'],
    readTime: '7 min',
    isFeatured: false,
    journeyStages: ['just-diagnosed', 'starting-therapy'],
    whyNow: 'Naming the grief out loud is often the move that loosens the stuck place.',
    whoItsFor: 'Parents who feel guilty for any feelings other than gratitude.',
    question: 'Am I allowed to grieve and still love my child?',
    action: 'Read once. Then read again on a heavier day.',
    reviewedBy: 'Common Ground (placeholder content)',
    lastUpdated: 'May 2026',
    isDemo: true,
  },
  {
    id: 'r-cg-sleep',
    title: 'Sleep when you’re the one holding everything together',
    description:
      'Practical, parent-real strategies for getting any sleep at all when your nights belong to your child.',
    category: 'caregiver-wellness',
    tags: ['sleep', 'practical', 'caregiver care'],
    ageRanges: ['0-2', '2-5', '6-12', '13-17'],
    readTime: '5 min',
    isFeatured: false,
    journeyStages: ['starting-therapy'],
    whyNow: 'Sleep loss compounds every other weight. Even one extra hour matters.',
    whoItsFor: 'Caregivers who haven’t slept through the night in months.',
    question: 'How do other parents make this work?',
    action: 'Pick one of the five strategies and try it for three nights.',
    reviewedBy: 'Common Ground (placeholder content)',
    lastUpdated: 'May 2026',
    isDemo: true,
  },
  {
    id: 'r-cg-couples',
    title: 'When your marriage feels the strain',
    description:
      'A short guide for couples navigating the load of raising an autistic child together — including how to talk when there’s no time to talk.',
    category: 'caregiver-wellness',
    ...
    isFeatured: false,
    journeyStages: ['starting-therapy', 'school-transition'],
    whyNow: 'The relationship is often the first thing to quietly carry the weight, and the last thing to get attention.',
    whoItsFor: 'Couples who keep meaning to talk and never quite get there.',
    question: 'How do we make space for us when there’s no space left?',
    action: 'Try the 12-minute conversation script with your partner this week.',
    reviewedBy: 'Common Ground (placeholder content)',
    lastUpdated: 'May 2026',
    isDemo: true,
  },
  {
    id: 'r-cg-identity',
    title: 'Finding yourself again after a diagnosis',
    description:
      'An essay on the slow, deliberate work of staying yourself while becoming someone’s full-time caregiver.',
    category: 'caregiver-wellness',
    tags: ['identity', 'self', 'caregiver mental health'],
    ageRanges: ['2-5', '6-12', '13-17'],
    readTime: '6 min',
    isFeatured: false,
    journeyStages: ['starting-therapy', 'school-transition'],
    whyNow: 'You don’t have to choose between being a good parent and being yourself.',
    whoItsFor: 'Parents who can’t remember what they used to like.',
    question: 'Am I allowed to still want a life of my own?',
    action: 'Pick one small thing this week that is just yours. That’s the whole assignment.',
    reviewedBy: 'Common Ground (placeholder content)',
    lastUpdated: 'May 2026',
    isDemo: true,
  },

  // ── Therapy Options — example placeholders pending vetting ────────────
  {
    id: 'r-tx-parent-implemented',
    title: 'Parent-implemented strategies — what actually works at home',
    description:
      'Plain-language overview of evidence-based strategies parents can use at home, when they help, and when to call in professional support.',
    category: 'therapy-options',
    tags: ['parent-implemented', 'home strategies', 'evidence-based'],
    ageRanges: ['2-5', '6-12'],
    readTime: '10 min',
    isFeatured: false,
    journeyStages: ['starting-therapy'],
    whyNow: 'You’re already the most consistent person in your child’s day. This makes that work count.',
    whoItsFor: 'Parents who want to know what they can actually do, not just what therapists do.',
    question: 'What can I do at home that won’t make things worse?',
    action: 'Pick one strategy that fits your child’s age and try it for a week.',
    reviewedBy: 'Common Ground (placeholder content)',
    lastUpdated: 'May 2026',
    isDemo: true,
  },
  {
    id: 'r-tx-telehealth',
    title: 'Telehealth options for autism therapy',
    description:
      'A practical guide to what works (and what doesn’t) for ABA, speech, and OT delivered virtually — including how to know if your child is a fit.',
    category: 'therapy-options',
    tags: ['telehealth', 'virtual', 'access'],
    ageRanges: ['2-5', '6-12', '13-17'],
    readTime: '7 min',
    isFeatured: false,
    journeyStages: ['starting-therapy'],
    whyNow: 'Telehealth removes a real barrier, but it’s not the right fit for every kid.',
    whoItsFor: 'Families balancing distance, time, or capacity.',
    question: 'Could telehealth therapy actually work for us?',
    action: 'Walk the fit checklist. If it’s a yes, the directory has telehealth-only providers filtered.',
    reviewedBy: 'Common Ground (placeholder content)',
    lastUpdated: 'May 2026',
    isDemo: true,
  },
  {
    id: 'r-tx-school-based',
    title: 'School-based services — what your district owes you',
    description:
      'Texas-specific overview of speech, OT, and behavior services delivered through the school district as part of an IEP.',
    category: 'therapy-options',
    tags: ['school', 'IEP', 'services', 'Texas'],
    ageRanges: ['6-12', '13-17'],
    readTime: '12 min',
    isFeatured: false,
    journeyStages: ['school-transition'],
    whyNow: 'School-based services are often under-used because parents don’t know they’re there for the asking.',
    whoItsFor: 'Parents of school-age children navigating their IEP.',
    question: 'What therapies should the school be providing?',
    action: 'Use the request script in your next ARD meeting.',
    reviewedBy: 'Common Ground (placeholder content)',
    lastUpdated: 'May 2026',
    isDemo: true,
  },

  // ── Education & IEP — example placeholders pending vetting ────────────
  {
    id: 'r-ed-ard-prep',
    title: 'ARD meeting prep checklist',
    description:
      'A short, parent-real checklist for what to bring, what to ask, and what to never agree to in the room without time to think.',
    category: 'education-iep',
    tags: ['ARD', 'IEP', 'meetings', 'school', 'Texas'],
    ageRanges: ['6-12', '13-17'],
    readTime: '8 min',
    isFeatured: false,
    journeyStages: ['school-transition'],
    whyNow: 'ARD meetings move fast and the ones who came prepared get more.',
    whoItsFor: 'Parents heading into their first or fifth ARD meeting.',
    question: 'How do I walk in and not get steamrolled?',
    action: 'Print the checklist. Bring it. Read from it if you have to.',
    reviewedBy: 'Common Ground (placeholder content)',
    lastUpdated: 'May 2026',
    isDemo: true,
  },
  {
    id: 'r-ed-transition',
    title: 'Transition planning — middle school, high school, and beyond',
    description:
      'How to plan for your child’s transitions between school stages, including the legal handoffs that happen at 14, 18, and 22.',
    category: 'education-iep',
    tags: ['transition', 'IEP', 'adulthood'],
    ageRanges: ['13-17'],
    readTime: '15 min',
    isFeatured: false,
    journeyStages: ['school-transition'],
    whyNow: 'Transition planning legally starts at 14. Most families learn this years too late.',
    whoItsFor: 'Parents of middle and high school students.',
    question: 'What am I supposed to be planning for that no one has told me about?',
    action: 'Map the timeline against your child’s current age and identify the next deadline.',
    reviewedBy: 'Common Ground (placeholder content)',
    lastUpdated: 'May 2026',
    isDemo: true,
  },
  {
    id: 'r-ed-private',
    title: 'Evaluating private school fit',
    description:
      'A short guide to deciding whether a private school can actually meet your child’s needs — including the questions that get past the marketing.',
    category: 'education-iep',
    tags: ['private school', 'school fit', 'evaluation'],
    ageRanges: ['6-12', '13-17'],
    readTime: '9 min',
    isFeatured: false,
    journeyStages: ['school-transition'],
    whyNow: 'Private schools vary widely. The brochure is never the whole story.',
    whoItsFor: 'Families considering moving from public to private.',
    question: 'Will this school actually support my child or just be a different version of the same problem?',
    action: 'Use the visit-day question list when you tour.',
    reviewedBy: 'Common Ground (placeholder content)',
    lastUpdated: 'May 2026',
    isDemo: true,
  },
  {
    id: 'r-ed-evals',
    title: 'Getting evaluated for accommodations',
    description:
      'How to get a school evaluation moving when the district is dragging its feet, and what to do when the evaluation comes back too narrow.',
    category: 'education-iep',
    tags: ['evaluation', 'IEP', '504', 'accommodations'],
    ageRanges: ['6-12', '13-17'],
    readTime: '11 min',
    isFeatured: false,
    journeyStages: ['school-transition'],
    whyNow: 'A timely, complete evaluation is the foundation of every accommodation that follows.',
    whoItsFor: 'Parents whose school is slow to evaluate or whose child got a thin report back.',
    question: 'How do I get the evaluation we’re actually owed?',
    action: 'Send the written request template. Keep a copy. Mark the 60-day clock.',
    reviewedBy: 'Common Ground (placeholder content)',
    lastUpdated: 'May 2026',
    isDemo: true,
  },
...
export const guidedSteps: GuidedStep[] = [
  {
    ...
    milestone: 'Get a professional evaluation scheduled — the sooner you know, the sooner you can act',
    focus: 'Stop waiting. Getting your child evaluated is the single most important step you can take right now — and it can happen faster than you think.',
    title: 'You are noticing something. Your instincts are worth listening to.',
    description:
      'Maybe daycare said something. Maybe a milestone keeps getting delayed. Maybe it is a quiet worry that will not go away. Whatever brought you here — that instinct is worth taking seriously. The earlier a child gets evaluated, the earlier they can get the right support. You do not need to wait.',
    reassurance:
    ...
    whatCanWait: [
      'Reading every explanation on the internet before making one phone call',
      'Deciding whether this "is" autism before a professional has evaluated your child',
    ...
    checklist: [
      ...
      'Write down your top 3 questions before any appointment so you do not forget them in the moment.',
  ...
  },
  {
    ...
    milestone: 'Leave this week with one next step — not a complete plan',
    focus: 'You just received life-changing news. The only job right now is to take one stabilizing action and give yourself permission to feel everything.',
    title: 'Your child just received a diagnosis.',
    description:
      'What you are feeling right now — the relief, the grief, the urgency, the love — all of it is valid. This diagnosis is not a ceiling on your child. It is a door.',
    reassurance:
      'You do not have to figure this out alone, and you do not have to figure it out today. The fact that you are here — seeking answers, seeking support — already says everything about the kind of parent you are.',
    whatMattersNow: [
      'Giving yourself permission to feel whatever comes up — grief, relief, fear, love, and confusion can all be true at once',
      'Getting your child into ABA therapy as early as possible — the research on early intervention is the strongest predictor of long-term outcomes',
      'Finding support for yourself — because a parent who is resourced is the most powerful asset in their child\'s development',
    ],
    whatCanWait: [
      'Reading every article or joining every group this week',
      'Making long-range schooling decisions before therapy has started',
      'Having every answer before you make the first call',
    ],
    checklist: [
      ...
      'Choose one place to track everything: appointments, names, next steps. A notes app is enough.',
    ],
    supportEscalation: [
      'If you feel panicked or shut down — that is a normal trauma response to hard news. You do not have to push through it alone.',
