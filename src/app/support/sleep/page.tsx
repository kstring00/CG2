...
const TABS = [
  { key: 'the-reality',   label: 'The reality'       },
  { key: 'sleep-check',   label: 'Check your sleep',  lazy: true },
  { key: 'tonight',       label: 'Tonight'            },
  { key: 'myths-and-help', label: 'Myths & help'      },
];
  ...
  return (
    <div className="page-shell">
      ...
      <PageTabs tabs={TABS}>
        ...
        {/* ── Tab 1: The reality ───────────────────────────────────────── */}
        <>
          {/* Why caregiver sleep is uniquely disrupted */}
          ...
          {/* What chronic deprivation does to your brain
              Moved here from its original position after the myths section —
              groups with causes as part of "understanding the reality." */}
          <section className="rounded-3xl border border-surface-border bg-white p-6 sm:p-8 shadow-card">
            <div className="flex items-center gap-2 mb-2">
              <Brain className="h-5 w-5 text-brand-plum-600" />
        ...
        {/* ── Tab 2: Check your sleep (lazy — interactive Y/N quiz) ────── */}
        <>
          <section className="rounded-3xl border border-surface-border bg-white p-6 sm:p-8 shadow-card">
            <div className="flex items-center gap-2 mb-2">
