...
const resources = [
  {
    ...
    desc: 'Filter by insurance, location, and specialty. Search "autism families," "special needs parents," or "neurodiversity."',
...
const TABS = [
  { key: 'why-its-hard', label: "Why it's hard"  },
  { key: 'what-works',   label: 'What works'     },
  ...
  return (
    <div className="page-shell">
      ...
      <PageTabs tabs={TABS}>
        ...
        {/* ── Tab 1: Why it's hard ─────────────────────────────────────── */}
        <>
          {/* Opening truth card — research context only; quote lives in closing */}
          ...
          <section>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {breakingPoints.map((point, i) => {
                ...
                return (
                  <div key={i} className={`rounded-2xl border-2 p-5 ${c.card}`}>
        ...
        <>
          ...
          {/* Resources — rendered expanded (no accordion wrapper) */}
          <section className="rounded-3xl border border-surface-border bg-white p-6 sm:p-8 shadow-card">
